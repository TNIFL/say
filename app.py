...
def create_app():
    ...
    def build_prompt(input_text, selected_categories, selected_tones,
        ...
        return f"""
            ...
            2. 감정적인 표현(짜증, 비꼼, 불만 등)은 부드럽게 풀어서 최대한 없게 전달해.
            ...
            7. 카테고리에서 커뮤니티, 피드백을 제외하고는 감정이 담긴 말투는 최대한 안하는게 좋아.
            8. 커뮤니티 말투는 최대한 유머러스하게 해도 좋아.
               참고할게 없으면 국내의 디시인사이드 라는 커뮤니티를 참고해도 괜찮아.
            9. 존댓말 할 때는 거의 '다', '나', '까' 로 끝내는게 좋은데 너가 판단했을 때 '요' 자를 써도 될 것 같으면 사용해.
            <사람 말투 규칙>
            ...
            3. 감정이 섞이지 않은 예의 바른 구어체를 선호한다.
               - ‘~습니다’ 대신 ‘~해요’ / ‘~드려요’ 중심의 자연스러운 존댓말 사용.
               - 예: “도와드리겠습니다.” → “도와드릴게요.”
               - 예: “확인 부탁드립니다.” → “확인 한 번만 부탁드릴게요.”
